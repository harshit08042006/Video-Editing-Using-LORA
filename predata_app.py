...
BASE_TMP = os.path.expanduser("~/gradio_tmp")
os.makedirs(BASE_TMP, exist_ok=True)

os.environ["GRADIO_TEMP_DIR"] = BASE_TMP
...
def make_demo(
    ...
    with gr.Blocks() as demo:
        ...
        with gr.Tab("Upload Video"):
            with gr.Column():
                input_video_field = gr.Video(label="Upload Video File", format="mp4")
        ...
        def load_image_directory(img_dir, target_frames, target_width, target_height):
            ...
            # gr.Toast(f"Successfully loaded {final_frames} frame images!")
        ...
        def actually_extract_frames(video_file, target_frames, target_width, target_height):
            ...
            try:
                ...
                # Show success message
                # gr.Toast(f"Successfully extracted {extracted_frames} frames! SAM features ready.")
        ...
        def run_tracker_with_message():
            ...
            #     gr.Toast("Object tracking completed! Please check the generated videos.")
            return result
        ...
        def save_data_with_message(output_dir, concept_prefix, ckpt_path, learning_rate, 
            ...
            if "complete" in result.lower() or "success" in result.lower() or "finished" in result.lower():
                x=("Data processing and saving completed! Please follow the instructions at the top of the page for LoRA training.")
